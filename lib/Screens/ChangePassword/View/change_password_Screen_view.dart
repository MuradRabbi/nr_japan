            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                    ...
                    child: InkWell(
                      onTap: () {
                        if (oldPasswordTextController.text.isEmpty) {
                          Utils().showToast(
                              "Please type your old password", true);
                        } else if (newPasswordTextController
                            .text.isEmpty) {
                          Utils().showToast(
                          ...
                          Utils().showToast(
                              "Your given password is not same",
                              true);
                        } else {
                          Map<String, dynamic> bodyLogin = {
                            "authentication":
                            APIConstants.AUTHENTICATION,
                            "old_password":
                          ...
                          // controller.changePassword(bodyLogin);
                        }
                      },
                      child: BottomButton(
                          title: "SAVE PASSWORD",
